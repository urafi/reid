...
def main(args):
    ...
    train_source, num_classes = preprocess_train(root+'market/bounding_box_train', relabel=True)
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        with open('losses/rank1_2.txt', 'a') as the_file:
            the_file.write(str(all[0] * 100) + '\n')
        the_file.close()

        model_name = 'models/reidNet_' \
